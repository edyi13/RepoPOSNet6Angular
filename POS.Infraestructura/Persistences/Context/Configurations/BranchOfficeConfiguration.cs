...
namespace POS.Infrastructure.Persistences.Context.Configurations
{
    public class BranchOfficeConfiguration : IEntityTypeConfiguration<BranchOffice>
    {
        ...
        {
            builder.HasKey(e => e.BranchOfficeId).HasName("PK__BranchOf__27247FF99881A2F2");
            ...
            builder.HasOne(d => d.Business).WithMany(p => p.BranchOffices)
                ...
                .HasConstraintName("FK__BranchOff__Busin__5AEE82B9");

            builder.HasOne(d => d.District).WithMany(p => p.BranchOffices)
                .HasForeignKey(d => d.DistrictId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__BranchOff__Distr__5BE2A6F2");
        }
    }
}
